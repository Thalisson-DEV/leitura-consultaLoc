...
CREATE INDEX IF NOT EXISTS idx_clientes_conta_contrato ON cliente(conta_contrato);

-- Cria um índice na coluna 'numero_serie'
-- Corresponde ao método: buscarPorNumeroSerie()
CREATE INDEX IF NOT EXISTS idx_clientes_numero_serie ON cliente(numero_serie);

-- Cria um índice na coluna 'numero_poste'
-- Corresponde ao método: buscarPorNumeroPoste()
CREATE INDEX IF NOT EXISTS idx_clientes_numero_poste ON cliente(numero_poste);
...
CREATE INDEX IF NOT EXISTS idx_clientes_nome_cliente_lower ON cliente (LOWER(nome_cliente));
